...
class AddingCardFifthView extends StatelessWidget with CustomWidgets {
  const AddingCardFifthView({Key? key}) : super(key: key);
                  ...
                  background: Container(
                    decoration: BoxDecoration(
                      ...
                      color: context.isDark
                          ? Color.fromARGB(255, 158, 28, 19).withOpacity(0.5)
                    ...
                    child: Padding(
                      ...
                      child: SvgPicture.asset(Assets.icons.svg.iconRecycle,
                          ...
                          color: context.isDark
                              ? Color.fromARGB(239, 227, 193, 191)
                              : Color.fromARGB(255, 153, 26, 17),
                          width: 30,
                          height: 20),
                    ),
                  ),
                        ...
                        trailing: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: context.isDark
                                ...
                                : Color.fromARGB(255, 115, 165, 239)
                                    .withOpacity(0.3),
                          ),
                        ),
                      ),
